...
async function addStackOverflowData(result) {
    ...
    if (data.items.length) {
        ...
        result.innerHTML = result.innerHTML + `<div><img src="http://img.shields.io/badge/-${score}-blue.svg?label=score&color=F8752E&&style=for-the-badge&logo=data:image/svg+xml;base64,"></img></div>`;
    }
